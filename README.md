...
Point Claude Code / Cowork at this repo as a plugin (or add it to a
marketplace). The schema travels with the skill, so consumers don't need the
care source tree to build queries.
