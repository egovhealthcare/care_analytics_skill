# emr_facilitymonetoryconfig JSONB schemas
 ...
 "candidate_schemas": [
  {
   ...
   "spec": "care.emr.resources.facility.spec.FacilityMonetaryCodeSpec"
  }
 ],
 "default_shape": {
  "type": "object"
...
```json
{
 "candidate_schemas": [
  {
   "annotation": "list[MonetaryComponentDefinition]",
   "excluded_by_spec": false,
   "required": true,
   "schema": {
    "items": {
     "raw": "MonetaryComponentDefinition",
     "ref": "MonetaryComponentDefinition",
     "type": "ref"
    },
    "raw": "list[MonetaryComponentDefinition]",
    "type": "array"
   },
   "source": "pydantic_spec",
   "source_file": "care/emr/resources/facility/spec.py",
 ...
 "definitions": [
  {
   ...
   "name": "MonetaryComponentDefinition",
   "source_file": "care/emr/resources/common/monetary_component.py",
   "spec": "care.emr.resources.common.monetary_component.MonetaryComponentDefinition"
  },
  {
   "fields": [
    {
