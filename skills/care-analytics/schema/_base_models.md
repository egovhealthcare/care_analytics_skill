...
- `status` string(20) choices=Status.choices default=Status.REQUESTED.value
- `purpose` string(20) choices=Purpose.choices default=Purpose.CARE_MANAGEMENT.value
- `hi_types` array<string> default=list
- `hip` string(50) NULL
- `hiu` string(50) NULL
- `requester` foreign_key -> users_user [col: requester_id] NULL
- `access_mode` string(20) choices=AccessMode.choices default=AccessMode.VIEW.value
...
- `frequency_unit` string(20) choices=FrequencyUnit.choices default=FrequencyUnit.HOUR.value
...
- `level` string(32) NULL idx choices=ExtensionLevel.choices
